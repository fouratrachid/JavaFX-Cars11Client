...
public class Voiture {
    ...
    // construc 1
    public Voiture(String Mtv, Date dv, Date da, String marque, String Modele, int price, String img, String etat) throws ParseException {
        this.MatriculeV = Mtv;
        this.dateVisite = dv;
        this.dateAssu = da;
        this.Marque = marque;
